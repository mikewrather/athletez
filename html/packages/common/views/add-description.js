...
define([
    ...
    AddImageView = BaseView.extend({
        ...
        initializeData: function() {
	        ...
	        this.messages =  {
		        fans: {left: "Become a fan and get notified whenever there's any activity for "+this.teamName+". Get notifications for new games or game changes, photos, videos, new team members or new messages.", "btn1": "Click here to add yourself to the fan's list and receive notifications.", btn2: "Click here to invite friends from facebook to receive notifications."},
