...
define(['facade', 'collections', 'sportorg/models/position', 'utils'], function(facade, collections, SportorgPositionModel, utils) {

	var SportorgPositionList, BaseCollection = collections.BaseCollection, _ = facade._, Channel = utils.lib.Channel;
