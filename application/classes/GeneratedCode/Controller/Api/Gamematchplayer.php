 ...
 */
	...
	class Controller_Api_Gamematchplayer extends Controller_Api_Base
	{
		...
		public function action_post_add()
		{
			...
			{
				$arguments["game_matches_id"] = (int)trim($this->request->post('game_matches_id'));
			}
		...
		public function action_put_basics()
		{
			...
			{
				$arguments["points_awarded"] = (int)trim($this->put('points_awarded'));
			}
			...
			if($this->put('match_winner') != "")
			{
				...
				$arguments["match_winner"] = (bool)$this->put('match_winner');
			}
