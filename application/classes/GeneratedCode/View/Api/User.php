 ...
 */
	...
	class View_Api_User extends Api_Viewclass
	{
		...
		/**
		 * post_fbreg() Register a new user with Facebook oAuth.  This will pull name, email, gender, birthday, and potentially high school for registration purpose.
		 *
		 * @retun array
		 */
