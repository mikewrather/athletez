 ...
 *
 * Date: Auto-generated on Apr 11th, 2013 12:35 am
 *
 * @author: Mike Wrather
 *
 */
	...
	class Controller_Api_Comment extends Controller_Api_Base
	{
		...
		public function action_get_getall()
		{
			...
			if((int)trim($this->request->query('subject_type_id')) > 0)
			{
				$arguments["subject_type_id"] = (int)trim($this->request->query('subject_type_id'));
			}
